...
async def start_consumer():
    ...
    queue = await consume_channel.declare_queue(CONSUME_QUEUE, durable=True)  # this service's queue
    await queue.bind(exchange)                          # subscribe my queue to the exchange
    ...
    logging.info(f"👂 dast-scanner listening on [{CONSUME_QUEUE}]")
